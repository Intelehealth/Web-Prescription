...
<script src="js/vfs_fonts.js"></script>
    ...
    <body>
		...
		<div class="col-md-2 col-sm-2">
			<img src="hih-logo.png" width="50%">
		</div>
            <div class="col-md-8 col-sm-8" style="text-align:center">
                <span><strong>हाथों मे हाथ</strong></span>
                <br>
                <span ><strong>Hand In Hand</strong></span>
            </div>
						...
						else
						{
							finalComplaint+=complaintString[counter].slice(4, -2)+"<br>";
                                  ...
                                  //  }
                                    ...
                                    if(data.medicalAdvice == '' || data.medicalAdvice.substring(0,2)=='; ' )
                                    {
...
//                                        $('#advice_heading').html('<b><u>General Advice/सामान्य सलाह</u></b><br><div style="font-size:14px;">'+kk.substr(2)+1<br></div>");
                                    ...
                                    {
                                        console.log("data.medicalAdvice...", data.medicalAdvice)
...
footer : {text : 'Hand In Hand Helpline Number - ', alignment:'center'}
}
