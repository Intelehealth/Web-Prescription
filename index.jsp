    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function checkD() {
                $('#errDesc').text('');
                jQuery.ajax({
                    url: "https://development.mysmartcaredoc.com/prescription/prescription/visitData",
                    type: "POST",
                    data: JSON.stringify({
                    ...
                    success: function (data) {
                        ...
                        if (data.status == "No Data found") {
                            ...
                            $('#vitals').html('<b>Vitals<br></b>Temperature(F): ' +(data.temperature > 0 ? ((data.temperature * 1.8) + 32).toFixed(2): 0) + ' | Height(cm): ' + data.height + ' | Weight(kg): ' + data.weight +
                                    ...
                                    ' ECG:'+ "<br>"+ 'Respiratory rate: ' + ecg.repositoryRate + ' | HRV(ms): ' + ecg.hrv +' | Heart rate(bpm): ' + ecg.heartRate);
                            }
